    ...
    for db_file in files:
        try:
            ...
            for row in cursor.fetchall():
                ...
                received_size = format_size(received_bytes) if received_bytes else "0 B"
                downloads.append([start_time_utc, end_time_utc, target_path, total_size, received_size, danger_description, interrupt_description, opened_description, browser, user_profile, db_file])
            conn.close()
